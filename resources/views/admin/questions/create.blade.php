...
@section('header', 'New Question Record')
                ...
                <div>
                    ...
                    <select name="meeting_id" id="meeting_id" required
                        ...
                        @foreach($meetings as $meeting)
                            <option value="{{ $meeting->id }}">{{ $meeting->name }} ({{ $meeting->session_number }})</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="questioner_id" id="questioner_id" required
                        ...
                        @foreach($participants as $participant)
                            <option value="{{ $participant->id }}">{{ $participant->name }} ({{ $participant->title }})</option>
                        @endforeach
                    </select>
                </div>
