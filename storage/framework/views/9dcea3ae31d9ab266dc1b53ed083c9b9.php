<?php $__env->startSection('header', 'Create Participant'); ?>
...
<div class="max-w-2xl">
    ...
    <div class="bg-slate-800/50 p-8 rounded-2xl border border-slate-700">
        <form action="<?php echo e(route('admin.participants.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zipa-hansad\resources\views/admin/participants/create.blade.php ENDPATH**/ ?>